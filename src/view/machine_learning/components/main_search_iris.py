#
# main_search_iris.py Copyright (c) 2022 Jalasoft.
...
class MainSearchIrisWidget(QWidget):
    def __init__(self):
        super().__init__()
    ...
    def left_layout(self):
        ...
        models = QComboBox()
        models.addItem("Search Iris")
        models.addItem("Search Face")
        ...
        menu = QVBoxLayout()
        menu.addWidget(QLabel("Iris Recognizer"))
        menu.addWidget(QLabel("You Want to:"))
        menu.addWidget(models)
        menu.addWidget(QLabel("Iris image Path:"))
