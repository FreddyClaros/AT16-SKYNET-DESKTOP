#
# ml_object_view.py Copyright (c) 2022 Jalasoft.
...
from src.view.machine_learning.components.main_object import MainObjectWidget


class MLObjectView(QMainWindow):
    def __init__(self):
        super().__init__()
        self.main_widget = MainObjectWidget()

    def init_ui(self):
        self.setWindowTitle("Object Recognizer")
