#
# ml_emotion.py Copyright (c) 2022 Jalasoft.
...
from src.view.machine_learning.components.main_emotion import MainEmotionWidget


class MLEmotionView(QMainWindow):
    def __init__(self):
        super().__init__()
        self.main_widget = MainEmotionWidget()
